...
public abstract class RYGPSProvider implements LocationListener {
     ...
     * @param context
     */
    public RYGPSProvider(@NonNull Context context) {
     ...
     */
    public RYGPSProvider(@NonNull Context context, @NonNull RYLocationProperties RYLocationProperties) {
    ...
    public final void startListen() throws InterruptedException {
        if (!this.mIsListening) {
            ...
            mLocationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, mRYLocationProperties.getRegularUpdateTime(), 0, this);
            mIsListening = true;
